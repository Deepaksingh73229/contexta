...
const features = [
    {
        icon: <MessageSquareText className="h-10 w-10 text-purple-600 dark:text-purple-400" />,
    ...
    {
        icon: <ShieldCheck className="h-10 w-10 text-purple-600 dark:text-purple-400" />,
        ...
        <section id="features" className="py-24 bg-zinc-50 dark:bg-zinc-900/50 border-y border-zinc-200 dark:border-zinc-800">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Designed for the <span className="text-purple-500">modern</span> administrator.</h2>
                    <p className="text-xl text-zinc-600 dark:text-zinc-400">Stop wasting hours manually digging through digital filing cabinets.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {features.map((feature, index) => (
                        <Card key={index} className="bg-white dark:bg-zinc-900/80 border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-md transition-all">
                            <CardHeader>
                                <div className="mb-4 p-3 bg-purple-50 dark:bg-purple-950/50 rounded-2xl w-fit">
                                    {feature.icon}
                                </div>
