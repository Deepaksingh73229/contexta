...
export default function Hero () {
    return (
        <section className="relative pt-20 pb-24 md:pt-32 md:pb-32 overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-125 bg-indigo-500/10 dark:bg-indigo-500/20 blur-[120px] rounded-full -z-10"></div>

            <div className="container mx-auto px-4 text-center">
                <Badge variant="secondary" className="mb-6 px-4 py-1.5 text-sm bg-indigo-50 text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-400 border-indigo-100 dark:border-indigo-900">
                    Introducing Institutional AI Memory
                </Badge>

                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-8 max-w-4xl mx-auto leading-tight">
                    Stop searching folders. <br className="hidden md:block" />
                    <span className="bg-clip-text text-transparent bg-linear-to-r from-indigo-600 to-violet-500 dark:from-indigo-400 dark:to-violet-400">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                    <Button size="lg" className="w-full sm:w-auto text-lg h-12 px-8 bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600">
                        Try the Demo
                    ...
                    <div className="p-6 md:p-12 bg-zinc-50/50 dark:bg-zinc-900/50">
                        ...
                        <div className="max-w-3xl mx-auto space-y-6">
                            ...
                            <div className="flex justify-end">
                                <div className="bg-indigo-600 text-white px-6 py-3 rounded-2xl rounded-tr-sm max-w-lg">
                            ...
                            <div className="mt-8 relative">
                                ...
                                <div className="absolute right-3 top-3 bg-indigo-600 p-2 rounded-lg">
